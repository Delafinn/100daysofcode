...
print(f"you have {guesses} guesses during this match!")
...
# Check user's guess against actual answer. Print "Too high." or "Too low." depending on the user's answer.
    ...
    if guessed_number == random_number:
        ...
        print(f"oof, the number you guessed was {guessed_number} too high, guess again.")
        time.sleep(2)
        guesses -= 1
        if guesses == 0:
        ...
        print(f"oof, the number you guessed was {guessed_number} too low, guess again.")
        time.sleep(2)
        guesses -= 1
        if guesses == 0:
            print(f"Oh no! you lose! \n the random number was : {random_number}")
