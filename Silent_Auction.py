# Silent Auction strictly has to be ran through terminal or command prompt.
...
# TODO find a way to remove the question if there is another user. this way the program assumes more users are bidding and an admin
# can end the bidding at their will.
