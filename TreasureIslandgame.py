...
while True:
  first_question = input('Youre at a crossroad. Where do you want to go? Type "left" or "right"')
  ...
  if first_question == "left" or first_question == "LEFT" or first_question == "Left":
    second_question = input('Youve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across.')
    ...
    if second_question == "wait" or second_question == "WAIT" or second_question == "Wait":
      third_question = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?")
